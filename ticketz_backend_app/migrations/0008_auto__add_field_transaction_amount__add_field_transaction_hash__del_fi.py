...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ticketz_backend_app_transaction', 'amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Transaction.hash'
        db.add_column('ticketz_backend_app_transaction', 'hash',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.payment_id'
        db.delete_column('ticketz_backend_app_userprofile', 'payment_id')

        # Deleting field 'UserProfile.client_id'
        db.delete_column('ticketz_backend_app_userprofile', 'client_id')
        ...
        # Adding unique constraint on 'UserProfile', fields ['uuid']
        db.create_unique('ticketz_backend_app_userprofile', ['uuid'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['uuid']
        db.delete_unique('ticketz_backend_app_userprofile', ['uuid'])

        # Deleting field 'Transaction.amount'
        db.delete_column('ticketz_backend_app_transaction', 'amount')

        # Deleting field 'Transaction.hash'
        db.delete_column('ticketz_backend_app_transaction', 'hash')

        # Adding field 'UserProfile.payment_id'
        db.add_column('ticketz_backend_app_userprofile', 'payment_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.client_id'
        db.add_column('ticketz_backend_app_userprofile', 'client_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'ticketz_backend_app.business': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 19, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 19, 0, 0)'})
        },
