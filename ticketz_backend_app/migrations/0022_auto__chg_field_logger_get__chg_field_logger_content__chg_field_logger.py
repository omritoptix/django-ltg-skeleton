...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Logger.get'
        db.alter_column('ticketz_backend_app_logger', 'get', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Logger.content'
        db.alter_column('ticketz_backend_app_logger', 'content', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Logger.free_text'
        db.alter_column('ticketz_backend_app_logger', 'free_text', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Logger.path'
        db.alter_column('ticketz_backend_app_logger', 'path', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Logger.post'
        db.alter_column('ticketz_backend_app_logger', 'post', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Logger.get'
        db.alter_column('ticketz_backend_app_logger', 'get', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Logger.content'
        db.alter_column('ticketz_backend_app_logger', 'content', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Logger.free_text'
        db.alter_column('ticketz_backend_app_logger', 'free_text', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Logger.path'
        db.alter_column('ticketz_backend_app_logger', 'path', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Logger.post'
        db.alter_column('ticketz_backend_app_logger', 'post', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        ...
        'ticketz_backend_app.businessprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 5, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 5, 0, 0)'})
        },
