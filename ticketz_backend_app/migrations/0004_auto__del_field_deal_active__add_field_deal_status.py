...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('ticketz_backend_app_deal', 'active')

        # Adding field 'Deal.status'
        db.add_column('ticketz_backend_app_deal', 'status',
    ...
    def backwards(self, orm):
        ...
        db.add_column('ticketz_backend_app_deal', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Deal.status'
        db.delete_column('ticketz_backend_app_deal', 'status')
    ...
    models = {
        ...
        'ticketz_backend_app.business': {
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'business'", 'to': "orm['ticketz_backend_app.UserProfile']"}),
