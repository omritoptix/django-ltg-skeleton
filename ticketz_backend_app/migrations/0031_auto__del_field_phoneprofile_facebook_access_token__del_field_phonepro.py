...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('ticketz_backend_app_phoneprofile', 'facebook_access_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'ticketz_backend_app.businessprofile': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)'})
        },
