...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ticketz_backend_app_pushnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 19, 0, 0))),
            ('modified_data', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 19, 0, 0), auto_now=True, blank=True)),
            ('phone_profile', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='push_notification', null=True, to=orm['ticketz_backend_app.PhoneProfile'])),
            ('apn_token', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, unique=True, null=True, blank=True)),
            ('gcm_token', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('ticketz_backend_app', ['PushNotification'])

        # Deleting field 'PhoneProfile.apn_token'
        db.delete_column('ticketz_backend_app_phoneprofile', 'apn_token')

        # Deleting field 'PhoneProfile.gcm_token'
        db.delete_column('ticketz_backend_app_phoneprofile', 'gcm_token')


    def backwards(self, orm):
        # Deleting model 'PushNotification'
        db.delete_table('ticketz_backend_app_pushnotification')

        # Adding field 'PhoneProfile.apn_token'
        db.add_column('ticketz_backend_app_phoneprofile', 'apn_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PhoneProfile.gcm_token'
        db.add_column('ticketz_backend_app_phoneprofile', 'gcm_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'ticketz_backend_app.businessprofile': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'})
        },
        ...
        'ticketz_backend_app.pushnotification': {
            ...
            'apn_token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
            'gcm_token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
