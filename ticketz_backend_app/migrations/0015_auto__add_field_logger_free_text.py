...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Logger.free_text'
        db.add_column('ticketz_backend_app_logger', 'free_text',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Logger.free_text'
        db.delete_column('ticketz_backend_app_logger', 'free_text')
