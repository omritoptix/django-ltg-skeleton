...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlatPage.icon_name'
        db.add_column('ticketz_backend_app_flatpage', 'icon_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlatPage.icon_name'
        db.delete_column('ticketz_backend_app_flatpage', 'icon_name')
