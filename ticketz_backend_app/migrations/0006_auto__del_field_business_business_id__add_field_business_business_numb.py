...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Business.business_number'
        db.add_column('ticketz_backend_app_business', 'business_number',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('ticketz_backend_app_business', 'business_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, unique=True),
                      keep_default=False)

        # Deleting field 'Business.business_number'
        db.delete_column('ticketz_backend_app_business', 'business_number')
