...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ticketz_backend_app_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Category.image'
        db.alter_column('ticketz_backend_app_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
