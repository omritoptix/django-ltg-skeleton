...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserProfile', fields ['phone']
        db.create_unique('ticketz_backend_app_userprofile', ['phone'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'UserProfile', fields ['phone']
        db.delete_unique('ticketz_backend_app_userprofile', ['phone'])
    ...
    models = {
        ...
        'ticketz_backend_app.business': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 0, 0)'})
        },
        ...
        'ticketz_backend_app.transaction': {
            'Meta': {'unique_together': "(('user_profile', 'hash'),)", 'object_name': 'Transaction'},
        ...
        'ticketz_backend_app.unpaidtransaction': {
            'Meta': {'unique_together': "(('user_profile', 'deal'), ('user_profile', 'hash'))", 'object_name': 'UnpaidTransaction'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 0, 0)'}),
