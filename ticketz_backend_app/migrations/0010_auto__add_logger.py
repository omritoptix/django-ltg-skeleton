...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Logger'
        db.create_table('ticketz_backend_app_logger', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 20, 0, 0))),
            ('modified_data', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 20, 0, 0), auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ('path', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True)),
            ('post', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('get', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('content', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('ticketz_backend_app', ['Logger'])


    def backwards(self, orm):
        # Deleting model 'Logger'
        db.delete_table('ticketz_backend_app_logger')
    ...
    models = {
        ...
        'ticketz_backend_app.business': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'})
        },
