...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.search_index'
        db.add_column('ticketz_backend_app_deal', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.search_index'
        db.delete_column('ticketz_backend_app_deal', 'search_index')
