...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhoneProfile.is_anonymous'
        db.add_column('ticketz_backend_app_phoneprofile', 'is_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhoneProfile.is_anonymous'
        db.delete_column('ticketz_backend_app_phoneprofile', 'is_anonymous')
    ...
    models = {
        ...
        'ticketz_backend_app.businessprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'})
        },
