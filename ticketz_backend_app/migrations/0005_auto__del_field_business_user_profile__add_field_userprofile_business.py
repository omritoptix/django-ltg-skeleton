...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ticketz_backend_app_userprofile', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='user_profile', null=True, blank=True, to=orm['ticketz_backend_app.Business']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('ticketz_backend_app_business', 'user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='business', to=orm['ticketz_backend_app.UserProfile']),
                      keep_default=False)
