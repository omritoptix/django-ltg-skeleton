...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhoneProfile.facebook_access_token'
        db.alter_column('ticketz_backend_app_phoneprofile', 'facebook_access_token', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'PhoneProfile.facebook_access_token'
        db.alter_column('ticketz_backend_app_phoneprofile', 'facebook_access_token', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        'ticketz_backend_app.phoneprofile': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
            'facebook_access_token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '300', 'null': 'True', 'blank': 'True'}),
