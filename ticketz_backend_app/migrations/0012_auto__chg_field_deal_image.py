...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.image'
        db.alter_column('ticketz_backend_app_deal', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Deal.image'
        db.alter_column('ticketz_backend_app_deal', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
