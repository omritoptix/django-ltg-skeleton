...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhoneProfile.uuid'
        db.delete_column('ticketz_backend_app_phoneprofile', 'uuid')


    def backwards(self, orm):
        # Adding field 'PhoneProfile.uuid'
        db.add_column('ticketz_backend_app_phoneprofile', 'uuid',
