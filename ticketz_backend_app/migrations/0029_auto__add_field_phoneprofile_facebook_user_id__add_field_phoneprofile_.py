...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhoneProfile.facebook_user_id'
        db.add_column('ticketz_backend_app_phoneprofile', 'facebook_user_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PhoneProfile.facebook_access_token'
        db.add_column('ticketz_backend_app_phoneprofile', 'facebook_access_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhoneProfile.facebook_user_id'
        db.delete_column('ticketz_backend_app_phoneprofile', 'facebook_user_id')

        # Deleting field 'PhoneProfile.facebook_access_token'
        db.delete_column('ticketz_backend_app_phoneprofile', 'facebook_access_token')
    ...
    models = {
        ...
        'ticketz_backend_app.businessprofile': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'ticketz_backend_app.deal': {
            ...
            'valid_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
            'valid_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'})
        },
        ...
        'ticketz_backend_app.phoneprofile': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
            'facebook_access_token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'facebook_user_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
