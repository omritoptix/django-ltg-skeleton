...
class UtilitiesResetPasswordTest(ResourceTestCase):
    ...
    def test_reset_password(self):
        ...
        user1 = User.objects.get(email='omri@ltgexam.com')
        user1_authentication_header = 'ApiKey ' + user1.username + ':' + user1.api_key.key
        ...
        result = authenticate(username=user1.username, password='1234567899')
        ...
        user2 = User.objects.get(email='tzachi@ltgexam.com')
        user2_authentication_header = 'ApiKey: '+user2.username+':'+user2.api_key.key 
