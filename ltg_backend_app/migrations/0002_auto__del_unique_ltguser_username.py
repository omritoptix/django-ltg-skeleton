...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LtgUser', fields ['username']
        db.delete_unique(u'ltg_backend_app_ltguser', ['username'])


    def backwards(self, orm):
        # Adding unique constraint on 'LtgUser', fields ['username']
        db.create_unique(u'ltg_backend_app_ltguser', ['username'])
    ...
    models = {
        ...
        u'ltg_backend_app.attempt': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)'}),
            'duration': ('timedelta.fields.TimedeltaField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'ltg_backend_app.ltguser': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "'f2c76c6ea87a47c58db1a884ff9313'", 'max_length': '30'}),
