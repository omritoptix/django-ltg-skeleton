...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionSetAttempt.user_profile'
        db.add_column(u'ltg_backend_app_questionsetattempt', 'user_profile',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'QuestionSetAttempt.user_profile'
        db.delete_column(u'ltg_backend_app_questionsetattempt', 'user_profile_id')
    ...
    models = {
        ...
        u'ltg_backend_app.attempt': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)'}),
            'duration': ('timedelta.fields.TimedeltaField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
