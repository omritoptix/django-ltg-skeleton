...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FlashcardTurned', fields ['user', 'flashcard']
        db.create_unique(u'ltg_backend_app_flashcardturned', ['user_id', 'flashcard_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FlashcardTurned', fields ['user', 'flashcard']
        db.delete_unique(u'ltg_backend_app_flashcardturned', ['user_id', 'flashcard_id'])
    ...
    models = {
        ...
        u'ltg_backend_app.ltguser': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "'0875927c3beb42a697bf7dc5546867'", 'max_length': '30'}),
