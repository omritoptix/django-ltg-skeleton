...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LtgUser.language'
        db.add_column(u'ltg_backend_app_ltguser', 'language',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.num_of_sessions'
        db.add_column(u'ltg_backend_app_ltguser', 'num_of_sessions',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LtgUser.test_date'
        db.add_column(u'ltg_backend_app_ltguser', 'test_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.previous_GMAT_score'
        db.add_column(u'ltg_backend_app_ltguser', 'previous_GMAT_score',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.target_GMAT_score'
        db.add_column(u'ltg_backend_app_ltguser', 'target_GMAT_score',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.post_GMAT_score'
        db.add_column(u'ltg_backend_app_ltguser', 'post_GMAT_score',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.platform_last_logged_in'
        db.add_column(u'ltg_backend_app_ltguser', 'platform_last_logged_in',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.device_last_logged_in'
        db.add_column(u'ltg_backend_app_ltguser', 'device_last_logged_in',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LtgUser.tutor_id'
        db.add_column(u'ltg_backend_app_ltguser', 'tutor_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LtgUser.language'
        db.delete_column(u'ltg_backend_app_ltguser', 'language')

        # Deleting field 'LtgUser.num_of_sessions'
        db.delete_column(u'ltg_backend_app_ltguser', 'num_of_sessions')

        # Deleting field 'LtgUser.test_date'
        db.delete_column(u'ltg_backend_app_ltguser', 'test_date')

        # Deleting field 'LtgUser.previous_GMAT_score'
        db.delete_column(u'ltg_backend_app_ltguser', 'previous_GMAT_score')

        # Deleting field 'LtgUser.target_GMAT_score'
        db.delete_column(u'ltg_backend_app_ltguser', 'target_GMAT_score')

        # Deleting field 'LtgUser.post_GMAT_score'
        db.delete_column(u'ltg_backend_app_ltguser', 'post_GMAT_score')

        # Deleting field 'LtgUser.platform_last_logged_in'
        db.delete_column(u'ltg_backend_app_ltguser', 'platform_last_logged_in')

        # Deleting field 'LtgUser.device_last_logged_in'
        db.delete_column(u'ltg_backend_app_ltguser', 'device_last_logged_in')

        # Deleting field 'LtgUser.tutor_id'
        db.delete_column(u'ltg_backend_app_ltguser', 'tutor_id')
    ...
    models = {
        ...
        u'ltg_backend_app.ltguser': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "'eaf84936f96a4024ba898434fe89a6'", 'max_length': '30'}),
