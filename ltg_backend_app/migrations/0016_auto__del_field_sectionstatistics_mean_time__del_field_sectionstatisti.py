...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SectionStatistics.mean_time'
        db.delete_column(u'ltg_backend_app_sectionstatistics', 'mean_time')

        # Deleting field 'SectionStatistics.mean_std'
        db.delete_column(u'ltg_backend_app_sectionstatistics', 'mean_std')

        # Adding field 'SectionStatistics.std_score'
        db.add_column(u'ltg_backend_app_sectionstatistics', 'std_score',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'ConceptStatistics.mean_std'
        db.delete_column(u'ltg_backend_app_conceptstatistics', 'mean_std')

        # Deleting field 'ConceptStatistics.mean_time'
        db.delete_column(u'ltg_backend_app_conceptstatistics', 'mean_time')

        # Adding field 'ConceptStatistics.std_score'
        db.add_column(u'ltg_backend_app_conceptstatistics', 'std_score',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SectionStatistics.mean_time'
        db.add_column(u'ltg_backend_app_sectionstatistics', 'mean_time',
                      self.gf('timedelta.fields.TimedeltaField')(default=1),
                      keep_default=False)

        # Adding field 'SectionStatistics.mean_std'
        db.add_column(u'ltg_backend_app_sectionstatistics', 'mean_std',
                      self.gf('timedelta.fields.TimedeltaField')(default=1),
                      keep_default=False)

        # Deleting field 'SectionStatistics.std_score'
        db.delete_column(u'ltg_backend_app_sectionstatistics', 'std_score')

        # Adding field 'ConceptStatistics.mean_std'
        db.add_column(u'ltg_backend_app_conceptstatistics', 'mean_std',
                      self.gf('timedelta.fields.TimedeltaField')(default=1),
                      keep_default=False)

        # Adding field 'ConceptStatistics.mean_time'
        db.add_column(u'ltg_backend_app_conceptstatistics', 'mean_time',
                      self.gf('timedelta.fields.TimedeltaField')(default=1),
                      keep_default=False)

        # Deleting field 'ConceptStatistics.std_score'
        db.delete_column(u'ltg_backend_app_conceptstatistics', 'std_score')
    ...
    models = {
        ...
        u'ltg_backend_app.sectionstatistics': {
            ...
            'mean_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ltg_backend_app.Concept']"}),
            'std_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {})
        },
