...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WrongAnswersPercentage.question_statistic'
        db.delete_column(u'ltg_backend_app_wronganswerspercentage', 'question_statistic_id')

        # Adding field 'WrongAnswersPercentage.question_statistics'
        db.add_column(u'ltg_backend_app_wronganswerspercentage', 'question_statistics',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2500, to=orm['ltg_backend_app.QuestionStatistics']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WrongAnswersPercentage.question_statistic'
        db.add_column(u'ltg_backend_app_wronganswerspercentage', 'question_statistic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2500, to=orm['ltg_backend_app.QuestionStatistics']),
                      keep_default=False)

        # Deleting field 'WrongAnswersPercentage.question_statistics'
        db.delete_column(u'ltg_backend_app_wronganswerspercentage', 'question_statistics_id')
