...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SectionStatistics.section'
        db.alter_column(u'ltg_backend_app_sectionstatistics', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ltg_backend_app.Section']))

    def backwards(self, orm):

        # Changing field 'SectionStatistics.section'
        db.alter_column(u'ltg_backend_app_sectionstatistics', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ltg_backend_app.Concept']))
