...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flashcard.section'
        db.add_column(u'ltg_backend_app_flashcard', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['ltg_backend_app.Section']),
                      keep_default=False)

        # Adding field 'Flashcard.lesson'
        db.add_column(u'ltg_backend_app_flashcard', 'lesson',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flashcard.section'
        db.delete_column(u'ltg_backend_app_flashcard', 'section_id')

        # Deleting field 'Flashcard.lesson'
        db.delete_column(u'ltg_backend_app_flashcard', 'lesson')
    ...
    models = {
        ...
        u'ltg_backend_app.attempt': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 5, 0, 0)'}),
            'duration': ('timedelta.fields.TimedeltaField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'ltg_backend_app.flashcard': {
            ...
            'lesson': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ltg_backend_app.Section']"})
        },
        u'ltg_backend_app.flashcardturned': {
            'Meta': {'unique_together': "(('user', 'flashcard'),)", 'object_name': 'FlashcardTurned'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 5, 0, 0)'}),
        ...
        u'ltg_backend_app.ltguser': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "'e49224f47a344ee8b77052bcd9d7ab'", 'max_length': '30'}),
