...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FlashcardTurned'
        db.create_table(u'ltg_backend_app_flashcardturned', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 3, 0, 0))),
            ('modified_data', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 3, 0, 0), auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ltg_backend_app.LtgUser'])),
            ('flashcard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ltg_backend_app.Flashcard'])),
        ))
        db.send_create_signal(u'ltg_backend_app', ['FlashcardTurned'])

        # Adding model 'Flashcard'
        db.create_table(u'ltg_backend_app_flashcard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 3, 0, 0))),
            ('modified_data', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 3, 0, 0), auto_now=True, blank=True)),
            ('index', self.gf('django.db.models.fields.IntegerField')(unique=True)),
        ))
        db.send_create_signal(u'ltg_backend_app', ['Flashcard'])


    def backwards(self, orm):
        # Deleting model 'FlashcardTurned'
        db.delete_table(u'ltg_backend_app_flashcardturned')

        # Deleting model 'Flashcard'
        db.delete_table(u'ltg_backend_app_flashcard')
    ...
    models = {
        ...
        u'ltg_backend_app.attempt': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 3, 0, 0)'}),
            'duration': ('timedelta.fields.TimedeltaField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'ltg_backend_app.flashcardturned': {
            'Meta': {'object_name': 'FlashcardTurned'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 3, 0, 0)'}),
            'flashcard': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ltg_backend_app.Flashcard']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ltg_backend_app.LtgUser']"})
        },
        u'ltg_backend_app.ltguser': {
            ...
            'flashcards_turned': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['ltg_backend_app.Flashcard']", 'through': u"orm['ltg_backend_app.FlashcardTurned']", 'symmetrical': 'False'}),
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': "'8e34b0363ba94ed3b5f4c97c619494'", 'max_length': '30'}),
