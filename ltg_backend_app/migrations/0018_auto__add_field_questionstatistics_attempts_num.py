...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionStatistics.attempts_num'
        db.add_column(u'ltg_backend_app_questionstatistics', 'attempts_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionStatistics.attempts_num'
        db.delete_column(u'ltg_backend_app_questionstatistics', 'attempts_num')
    ...
    models = {
        ...
        u'ltg_backend_app.attempt': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
