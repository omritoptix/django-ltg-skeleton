...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScoreTable.percentile'
        db.alter_column(u'ltg_backend_app_scoretable', 'percentile', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ScoreTable.percentile'
        db.alter_column(u'ltg_backend_app_scoretable', 'percentile', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))
    ...
    models = {
        ...
        u'ltg_backend_app.attempt': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)'}),
            'duration': ('timedelta.fields.TimedeltaField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
